        ...
        {!! Form::model($model,['class' => 'form-horizontal']) !!}
            ...
            @if(! $model || $model->type != 'core')
                <div class="form-group m-t-15">
                    ...
                    <div class="col-md-9">
                        <div class="col-md-12">
                            all site pages except {!! Form::radio('json_data[block_type]',0,true,['class' => 'block_pages_radio']) !!}
                            only these pages {!! Form::radio('json_data[block_type]',1,null,['class' => 'block_pages_radio']) !!}
                        </div>
