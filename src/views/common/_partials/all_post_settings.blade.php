@if($page)
    ...
    <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9 col-xl-9 page-data p-20">
        <div class="panel panel-default custompanel m-t-20">
            <div class="panel-heading">All Posts Info</div>
        ...
        <div class="panel panel-default custompanel m-t-20">
            <div class="panel-heading">Select specific Main Content</div>
            <div class="panel-body template_body">
                {!! BBbutton2('unit','template','all_posts',"Change",['class'=>'btn btn-default change-layout','data-action'=>'main_content','model'=>($page->content_type=='editor')?null:$page]) !!}
            </div>
        </div>
    </div>
