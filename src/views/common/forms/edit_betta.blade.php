            ...
            <div class="row " id="builderContain">
                <div class="col-xs-12 col-sm-6 previewAray">
                    ...
                    <div data-print="demehtml">
                        <div class="tabs-x " data-tabs="demo" data-class="setting">
                            ...
                            <div class="tab-content" data-tabs="tab-content" id="myTabContent-7" data-conclass="setting">

                            </div>
                        </div>
                    </div>

                    <textarea name="json_data" class="form-control" data-export="json" style="margin-top:100px;"></textarea>
                ...
                <div class="col-xs-12 col-sm-6 formoptions">
                    <ul class="stepNav list-unstyled tabStepnav tabNavs clearfix" data-inset="nav" >
                        <li class="active"><a href="#setting" aria-controls="setting" role="tab" data-toggle="tab" title="Step1" data-rolecss="setting" data-rolehtml="setting">Setting</a></li>
                        <li data-insetadd="addnav"><a href="#" title="Add New Tab" data-tabsactions="add"><i class="fa fa-plus" aria-hidden="true"></i></a></li>
                    </ul>
                        ...
                        <div role="tabpanel" class="tab-pane active" id="setting">
                            ...
                            <div class="row formrow form-horizontal">
                                <div class="form-group">
                                    <label class="col-sm-3" for="type"><span class="iconform arrowicon"></span> Type  </label>
                                    <div class="col-sm-6">
                                        <select id="type"  class="form-control customselect" data-style="btn-black" data-htmlclass="class" data-selector="type" data-css="type">
                            ...
                            <div class="row formrow form-horizontal">
                                <div class="form-group">
                                    <label class="col-sm-3" for="positions"><span class="iconform arrowicon"></span> Positions   </label>
                                    <div class="col-sm-6">
                                        <select id="positions"  class="form-control customselect" data-style="btn-black" data-htmlclass="class" data-selector="positions" data-css="positions">
                            ...
                            <div class="row formrow form-horizontal">
                                <div class="form-group" data-panel-showpositions="alignment">
                                    <label class="col-sm-3" for="alignment"><span class="iconform arrowicon"></span> Alignment   </label>
                                    <div class="col-sm-6">
                                        <select id="alignment" class="form-control customselect" data-style="btn-black" data-htmlclass="class" data-selector="alignment" data-css="alignment">
                                ...
                                <div class="form-group hide" data-panel-showpositions="sideways">
                                    <label class="col-sm-3" for="sideways "><span class="iconform arrowicon"></span> Sideways   </label>
                                    <div class="col-sm-6">
                                        <select id="sideways"  class="form-control customselect" data-style="btn-black" data-htmlclass="class" data-selector="sideways" data-css="sideways">
                            ...
                            <div class="row formrow form-horizontal">
                                <div class="form-group">
                                    <label class="col-sm-3" for="navclass"><span class="iconform arrowicon"></span>Tab class  </label>
                                    <div class="col-sm-6">
                                        <select id="navclass"  class="form-control customselect" data-style="btn-black" data-htmlclass="navclass" data-selector="containerclass" data-css="containerclass">
                            ...
                            <div class="row formrow form-horizontal">
                                <div class="form-group">
                                    <label class="col-sm-3" for="containerclass"><span class="iconform arrowicon"></span>Container class  </label>
                                    <div class="col-sm-6">
                                        <select id="containerclass"  class="form-control customselect" data-style="btn-black" data-htmlclass="conclass" data-selector="containerclass" data-css="containerclass">
                                            <option value="panelheading-blue">panelheading-blue</option>
                                            <option value="panelbody-blue">panelbody-blue</option>
                                            <option value="panelfooter-blue">panelfooter-blue</option>
                                            <option value="panelheading-yellow">panelheading-yellow</option>
...
@section( 'JS' )
    <script type="template" data-tabsappend="nav">
        <li><a href="#tabsprevew{index}" data-toggle="tab" data-navclass="setting" data-class="{index}"><i data-tabicon="enableIcon"></i><span data-tabtext="enabletext">{title}</span><span class="caret"></span></a></li>
    </script>
    ...
    <script type="template" data-tabs="nav">
        <li><a href="#{index}" aria-controls="{index}" role="tab" data-toggle="tab" title="{index}" data-rolecss="{index}" data-rolehtml="{index}">{title}</a> <a class="deletebtn" data-key="{index}" data-tabsactions="delele"><i class="fa fa-trash-o" aria-hidden="true"></i></a></li>
    </script>
    <script type="template" data-tabs="tabcontent">
        <div role="tabpanel" class="tab-pane" id="{index}">
            <div class="row formrow form-horizontal">
                <div class="form-group">
                    <label class="col-sm-3" for="enabletext"><div class="customelement">
                            <input type="checkbox" name="enabletext" id="enabletext"  value="icon" data-cssenable="enabletext" data-getcontainer="enabletext" > <label> Inset Text</label>
                        </div></label>
                    <div class="col-sm-3 hide" data-enable="enabletext">
                        <input class="form-control form-controlblack" name="enabletext" data-html="enabletext" value="Tab text" placeholder="Insert Text">
                    </div>
                    <div class="col-sm-3 hide" data-enable="enabletexts">
                        <select id="panetextclass" class="form-control customselect" data-style="btn-black"  data-htmlclass="class" data-selector="textclass" data-css="textclass">
            ...
            <div class="row formrow form-horizontal">
                <div class="form-group">
                    <label class="col-sm-3" > <div class="customelement">
                            <input type="checkbox" name="tabicon" id="enableIcon"  value="icon" data-cssenable="enableIcon" data-htmltype="icon" data-getcontainer="enableIcon" > <label> Insert Icon</label>
                        </div>
                    </label>

                    <div class="col-sm-3 hide" data-enable="enableIcon">
                        <button type="button" class="btn btn-default btn-black" data-icon="iconbutton">Select Icon</button>
                        <span class="iconView" data-iconview="enableIcon"><i class="fa fa-adjust"></i></span>
                        <input class="form-control form-controlblack hide geticonseting" name="enableIcon" data-html="enableIcon" data-htmltype="icon" value="fa fa-adjust">


                    </div>
                    <div class="col-sm-3 hide" data-enable="enableIcon">
                        <select class="form-control customselect" data-selector="iconclass" data-css="class" data-htmlclass="enableIcon" data-style="btn-black ">
            ...
            <div class="row formrow form-horizontal">
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <div class="radio-inline customelement">
                            <input type="radio" data-getcontainer="" data-csstype="dropdownmenu" value="none" checked="checked" name="tabtype{index}"> <label> Standard</label>
                        </div>
                        <div class="radio-inline customelement">
                            <input type="radio" data-getcontainer="dropdownenable" data-csstype="dropdownmenu" value="dropdownmenu" name="tabtype{index}"> <label> Drop Down </label>
                        </div>
                    </div>
                ...
                <div class="collapse" data-showcontainer="dropdownenable">
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <select  class="form-control customselect" multiple data-style="btn-black" data-htmlclass="dropdownmenu" data-selector="dropdownmenu" data-css="dropdownmenu">
                                {dropdownmenu}
                            </select>
            ...
            <div class="row formrow form-horizontal">
                ...
                <div class="form-group hide" data-panel-show="text">
                    ...
                    <div class="col-sm-6">
                        <textarea class="form-control form-controlblack" name="middletext" id="middletext{index}"  data-html="middletext" value="Header" placeholder="Insert Text"></textarea>
                    </div>
                </div>
                ...
                <div class="form-group hide" data-panel-show="othercontent">
                    ...
                    <div class="col-sm-6">
                        <input type="file"  value="" data-show-preview="false" data-show-upload="false" data-allowed-file-extensions='["html", "txt", "php", "js"]' class="form-control form-controlblack file">
                    </div>
                </div>
