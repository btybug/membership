...
@section('tab')
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 m-t-15">
        ...
        <div class="col-md-12 m-t-30">
            ...
            <table id="blogs-archive-table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                <thead>
                <tr>
                    <th>#</th>
                    <th>Title</th>
...
@section('JS')
    ...
    <script>
        $(function () {
            ...
            var blogs_archive = $('#blogs-archive-table').DataTable({
                dom: 'Bfrtip',
                buttons: [
                    'copy', 'excel', 'pdf', {
                        text: 'Reload',
