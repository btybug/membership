...
@section('content')
    <div class="col-md-10">
        <a href="{!! route('mbsp_plans_create') !!}" class="btn btn-default btn-success pull-left" tabindex="0"
           aria-controls="fields-table"><span>Create New</span></a>
        <a href="{!! route('mbsp_settings') !!}" class="btn  btn-warning pull-right" tabindex="0"
           aria-controls="fields-table"><span>Settings</span></a>
